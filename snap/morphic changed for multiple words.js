...
WorldMorph.prototype.fillPage = function () {
    ...
    this.worldCanvas.style.left = undefined; // "0px";
    this.worldCanvas.style.right = undefined; // "0px";
    this.worldCanvas.style.width = undefined; // "100%";
    this.worldCanvas.style.height = undefined; // "100%";

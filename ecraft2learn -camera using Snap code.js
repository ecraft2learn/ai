...
//       document.body.appendChild(canvas);
  ...
  costume_from_camera_old: function (mirrored) {
  ...
  costume_from_camera: function (mirrored) {
      let myself = ecraft2learn.block_being_called;
      if (!myself.videoView) {
          CamSnapshotDialogMorph.prototype.buildContents(myself, mirrored);
      }
      let costume =
            new Costume(
                myself.videoView.fullImageClassic(),
                myself.newCostumeName('camera')
            );
       if (mirrored) costume.flipped()
       return costume;
//     } else {
//         return
//             new Costume(

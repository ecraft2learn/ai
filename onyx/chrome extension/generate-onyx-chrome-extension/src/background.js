...
const ONYX_MODEL_URL = "https://ecraft2learn.github.io/ai/onyx/models/19-08-2019b.json";
let onyx_model;
...
class ImageClassifier {
  ...
  async loadModel() {
    ...
    try {
      this.mobilenet = await mobilenet.load({version: 2, alpha: 1});
      this.model = this.mobilenet.model;
      this.onyx_model = await tf.loadLayersModel(ONYX_MODEL_URL);
//       this.model =

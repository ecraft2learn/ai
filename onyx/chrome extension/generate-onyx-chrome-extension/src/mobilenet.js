    ...
    var s = function() {
        ...
        e.prototype.infer = function(e, a) {
            ...
            r.tidy(function() {
                ...
                var i = e.toFloat().mul(o.inputRange).add(o.inputMin)
                  , t = i;
                if (224 !== e.shape[0] || 224 !== e.shape[1]) {
                    t = r.image.resizeBilinear(i, [224, 224], !0)
                }
                var l, s = t.reshape([-1, 224, 224, 3]);
                if (a) {
                    var c = n[o.version];
                    l = o.model.execute(s, c).squeeze([1, 2])
                } else {
                    l = o.model.predict(s).slice([0, 1], [-1, 1e3])
                }
                return l
            })
        }
        ...
        o(this, void 0, void 0, function() {
            ...
            return i(this, function(i) {
                ...
                case 0:
                    ...
                    if (o = e.version.toFixed(2),
                    t = e.alpha ? e.alpha.toFixed(2) : "",
                    n = -1,
                    c = 1,
                    null == e.modelUrl) {
                        if (!(o in l))
                        ...
                        if (!(t in l[o]))
                            throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(l[o]) + ".");
                        a = l[o][t].inputRange,
                        n = a[0],
                        c = a[1]
                    }
                    return [4, (u = new s(o,t,e.modelUrl,n,c)).load()];
                case 1:
                    return i.sent(),
                    [2, u]
                }

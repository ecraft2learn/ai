...
function textContentFromPrediction(predictions) {
    let scores = [];
    const class_names = ["<span style='background-color: #386838; display: block; color: white; padding: 4px; width: fit-content;'>normal</span>",
                         "<span style='background-color: #d6b862; display: block; color: white; padding: 4px; width: fit-content;'>abnormal but not serious",
                         "<span style='background-color: #a70606; display: block; color: white; padding: 4px; width: fit-content;'>check with a doctor"]

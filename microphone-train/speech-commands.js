    ...
    ***************************************************************************** */
    ...
    var BrowserFftFeatureExtractor = (function () {
        function BrowserFftFeatureExtractor(config) {
            ...
            var columnBufferLength = config.columnBufferLength || this.fftSize;
            var columnHopLength = config.columnHopLength || (this.fftSize / 2);
        ...
        BrowserFftFeatureExtractor.prototype.start = function (samples) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, streamSource, rotatingBufferSize;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            this.frameCount = 0;
                            this.tracker = new Tracker(Math.round(this.numFramesPerSpectrogram * this.overlapFactor), Math.round(this.suppressionTimeMillis / this.frameDurationMillis));
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.warmUpModel();
                            frameDurationMillis = this.parameters.columnBufferLength / this.parameters.sampleRateHz * 1e3;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, loadMetadataJson(this.MODEL_URL_PREFIX + "/" + this.vocabulary + "/metadata.json")];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, new Promise(function (resolve, reject) {
                            ...
                            _this.audioDataExtractor = new BrowserFftFeatureExtractor({
                                ...
                                columnBufferLength: _this.parameters.columnBufferLength,
                                columnHopLength: _this.parameters.columnBufferLength,
    ...
    function create(fftType, vocabulary) {

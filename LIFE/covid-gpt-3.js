...
function get_gpt3_embeddings (questions, callback) {
    const embeddings = questions.map(question => embeddings[all_questions.indexOf(question)]);
    callback(tf.tensor(embeddings));    
}
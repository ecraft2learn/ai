...
LIFE.sentences_and_answers = () => {
    ...
    group_of_questions.push([ // 0
        ...
        "Why is this limitted to children under 5?",
    ...
    group_of_questions.push(["How can we tell if there is cyanosis?", // 1
                             "What should I see if there cyanosis?"]);
    ...
    group_of_questions.push(["The ‘P’ is for pain but how should one access pain? ",
                             "How should tell how much pain there is?"]);
    ...
    group_of_questions.push(["How slow is a very slow large pulse? ",
                             "What rate is considred a very slow large pulse?"]);
